...
function frame(){
    ...
    drawCube(10*math.cos(Ry),10*math.sin(Ry),distance,math.sin(Rx),math.sin(Ry),math.sin(Rz),100,"Lime",'Purple');
    ...
    drawPentagon(10,-5,distance,math.sin(Rz),math.sin(Rx),math.sin(Rx),500,"Orange","Blue");
    drawPentagon(0,-5,distance,math.sin(Rx),math.sin(Ry),math.sin(Rz),500,"white","Green");
    drawPentagon(-10,-5,distance,math.sin(Rx),math.sin(Rz),math.sin(Rx),500,"Red","Yellow");
